...
# (미사용) TMAP 도보 정밀 검사 — 2-pass·직선 hub 선정으로 대체
# PARKING_TMAP_CANDIDATE_LIMIT = 20
# PARKING_TMAP_VALIDATE_LIMIT = 10
# PARKING_TMAP_CANDIDATE_MIN = 8
# PARKING_TMAP_CANDIDATE_PER_PLACE = 2
HUB_CLUSTER_ATTEMPT_LIMIT = 10  # 2/4 겹치는 hub 선정 진행 표시 상한
